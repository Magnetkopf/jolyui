  ...
  return (
    ...
    >
      <div className="flex flex-col items-center gap-2">
        <BeamNode ref={laptopRef} className="h-12 w-12 border-2 border-blue-500/20 bg-blue-500/10">
      ...
      <div className="flex flex-col items-center gap-2">
        <BeamNode ref={shieldRef} className="h-14 w-14 border-2 border-emerald-500/20 bg-emerald-500/10">
          <ShieldCheck className="h-7 w-7 text-emerald-600" />
        </BeamNode>
        <span className="text-[10px] font-medium uppercase tracking-wider text-muted-foreground">Encrypt</span>
      </div>

      <div className="flex flex-col items-center gap-2">
        <BeamNode ref={cloudRef} className="h-12 w-12 border-2 border-sky-500/20 bg-sky-500/10">
          <Cloud className="h-6 w-6 text-sky-600" />
        </BeamNode>
        <span className="text-[10px] font-medium uppercase tracking-wider text-muted-foreground">Cloud</span>
      </div>
