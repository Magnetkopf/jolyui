...
interface OrbitingCirclesContainerProps extends React.HTMLAttributes<HTMLDivElement> {
...
>(({ className, children, showPaths = true, pathRadii = [160], ...props }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
...
export {
    OrbitingCircles,
    OrbitingCirclesContainer, type OrbitingCirclesContainerProps, type OrbitingCirclesProps
};
